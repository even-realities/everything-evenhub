...
interface TextContainerProperty {
  ...
  borderColor: number      // 0–16, greyscale colour index
...
interface ListItemContainerProperty {
  ...
  isItemSelectBorderEn: 0 | 1  // 1 = show selection border around highlighted item
...
Defines a placeholder image container. Must be populated with `updateImageRawData` after creation.
...
Shared structure for `bridge.createStartUpPageContainer()` and `bridge.rebuildPageContainer()`.

```typescript
interface PageContainerSpec {
...
interface DeviceStatus {
  ...
  static createDefault(): DeviceStatus
}
```
...
// Values: P100, P200, P300, P400, P500, P600, P700, P800, P900, P1000
// Number represents milliseconds between reports (P100 = 100 ms = 10 Hz, P1000 = 1000 ms = 1 Hz)
enum ImuReportPace {
  P100 = 'P100',
  P200 = 'P200',
  P300 = 'P300',
