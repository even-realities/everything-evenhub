...
| `min_sdk_version` | string | yes | Minimum SDK version required. E.g. `"0.0.11"`. |
...
| `min_sdk_version: expected string, received undefined` | `min_sdk_version` is required. Add it to `app.json` (e.g. `"0.0.11"`). |
